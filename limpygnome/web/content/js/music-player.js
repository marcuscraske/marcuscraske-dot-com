// JavaScript HTML5 Player Controller
// ***********************************
// Author:      limpygnome
// Version:     January 2015 / 1.0
        ...
        if(node.className != null && node.className == "music_player")
        {
            ...
            if(elementsPlaylistItems.length > 0 && elementsAudio.length > 0)
            {
                ...
                player.onvolumechange = function(e)
                {
                    ...
                    button.src = "/content/images/music-player/" + (player.muted ? "muted" : "unmuted") + ".png";
                ...
                player.onplay = player.onpause = function(e)
                {
                    ...
                    button.src = "/content/images/music-player/" + (player.paused ? "play" : "pause") + ".png";
                };
            }
        }
    }
