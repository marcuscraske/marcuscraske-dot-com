---
title: Build TV
thumbnail: /projects/build-tv/thumb.png
year: 2015
date: "2015-01-01"
---
...
<ul class="gallery">
    <li>
        <a href="jira-wallboard.png">
            <img src="jira-wallboard.png" alt="Build TV showing Jira wallboard" title="Build TV showing Jira wallboard" />
            Build TV showing Jira wallboard
        </a>
    </li>
    <li>
        <a href="build-status-dashboard.jpg">
            <img src="build-status-dashboard.jpg" alt="Build status dashboard" />
            Build status dashboard
        </a>
    </li>
    <li>
        <a href="share-price-dashboard.jpg">
            <img src="share-price-dashboard.jpg" alt="Share price dashboard" />
            Share price dashboard
        </a>
    </li>
    <li>
        <a href="standup-notification.jpg">
            <img src="standup-notification.jpg" alt="Standup notification" />
