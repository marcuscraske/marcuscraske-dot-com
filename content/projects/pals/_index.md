...
thumbnail: /projects/pals/thumb.png
year: 2014
date: "2014-01-01"
---
...
# Overview
PALS is an [open source](https://github.com/marcuscraske/pals) assessment system for programming assignments,
...
[Github](https://github.com/marcuscraske/pals)
...
<https://github.com/marcuscraske/pals/releases>

# Project Report
<p>
    Click <a href="report.pdf">here</a> to download the final project report.
</p>
...
<ul class="gallery">
    <li>
        <a href="criteria_results_inputs.png" class="screenshot">
            <img src="criteria_results_inputs.png" alt="Criteria results" />
            The results from dynamic assessment of student code and correct code.
        </a>
    </li>
    <li>
        <a href="criteria_results_output.png" class="screenshot">
            <img src="criteria_results_output.png" alt="Standard in out testing" />
            Dynamic testing of standard input/output.
        </a>
    </li>
    <li>
        <a href="stats_hint.png" class="screenshot">
            <img src="stats_hint.png" alt="Feedback hint" />
            Feedback providing the student with a hint of the issue wrong.
        </a>
    </li>
    <li>
        <a href="stats.png" class="screenshot">
            <img src="stats.png" alt="Stats" />
            Stats for common issues.
        </a>
    </li>
    <li>
        <a href="testing_graph.png" class="screenshot">
            <img src="testing_graph.png" alt="Distributed test" />
            Graph of time to mark assessments with 1 to 5 nodes simultaneously.
        </a>
    </li>
    <li>
        <a href="erd.png" class="screenshot">
            <img src="erd.png" alt="ERD" />
            ERD for PALS.
        </a>
    </li>
    <li>
        <a href="home.png" class="screenshot">
            <img src="home.png" alt="Home" />
            The home page.
        </a>
    </li>
    <li>
        <a href="nodes.png" class="screenshot">
            <img src="nodes.png" alt="Nodes" />
            Administration page for nodes.
        </a>
    </li>
    <li>
        <a href="plugins.png" class="screenshot">
            <img src="plugins.png" alt="Plugins" />
            Administration page for plugins.
        </a>
    </li>
    <li>
        <a href="enrollment.png" class="screenshot">
            <img src="enrollment.png" alt="Enrollment" />
