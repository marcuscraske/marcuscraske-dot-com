---
title: Binary Clock
thumbnail: /projects/binary-clock/thumb.png
year: 2013
date: "2013-01-01"
---
...
# Purpose
<a href="binary-clock.png">
    <img src="binary-clock.png" alt="Final binary clock" title="Final binary clock" />
</a>
...
<ul class="gallery">
    <li>
        <a href="shift-registers.png">
            <img src="shift-registers.png" alt="Shift registers" title="Shift registers" />
            Shift registers for controlling multiple LEDs with three GPIO inputs
        </a>
    </li>
    <li>
        <a href="side-open.png">
            <img src="side-open.png" alt="Binary clock with side open" title="Binary clock with side open" />
            Binary clock with side open
        </a>
    </li>
    <li>
        <a href="website-home.png">
            <img src="website-home.png" alt="Website home" title="Website home" />
            Binary clock's homepage, served by the program its self. Written in C++ and multi-threaded using C++ 11.
        </a>
    </li>
    <li>
        <a href="website-options.png">
            <img src="website-options.png" alt="Website options" title="Website options" />
            Binary clock options
        </a>
    </li>
    <li>
        <a href="website-guest-book.png">
            <img src="website-guest-book.png" alt="Website guest book" title="Website guest book" />
            Guest book with IP geo-location using IP block lists from APNIC
        </a>
    </li>
    <li>
        <a href="website-cache.png">
            <img src="website-cache.png" alt="Website cache" title="Website cache" />
            Template and resource caching; assets are kept in memory to reduce I/O for high performance
        </a>
    </li>
    <li>
        <a href="website-database.png">
            <img src="website-database.png" alt="Website database" title="Website database" />
            Database test connection page
        </a>
    </li>
    <li>
        <a href="website-services.png">
            <img src="website-services.png" alt="Binary clock services" title="Binary clock services" />
            The services within the C++ program, which can be independently controlled and fail
        </a>
    </li>
    <li>
        <a href="website-tools.png">
            <img src="website-tools.png" alt="Website tools" title="Website tools" />
            Website tools menu
        </a>
    </li>
    <li>
        <a href="website-system-info.png">
            <img src="website-system-info.png" alt="System information" title="System information" />
            System information viewer
        </a>
    </li>
    <li>
        <a href="api.png">
            <img src="api.png" alt="Binary clock API XML" title="Binary clock API XML" />
            Website read-only API
        </a>
    </li>
    <li>
        <a href="website-tools-rng.png">
            <img src="website-tools-rng.png" alt="Website random number generator" title="Website random number generator" />
            Random number generator, using analogue data as seed
        </a>
    </li>
    <li>
        <a href="website-gpio.png">
            <img src="website-gpio.png" alt="Website GPIO menu" title="Website GPIO menu" />
            Binary clock GPIO menu, allowing conditions to turn actual power sockets on/off
        </a>
    </li>
    <li>
        <a href="website-gpio-configure.png">
            <img src="website-gpio-configure.png" alt="GPIO configuration" title="GPIO configuration" />
...
Pin layout:
<a href="shift_registers_pin_layout.png">
    <img src="shift_registers_pin_layout.png" class="thumb" style="width: 14em; height: 14em;" alt="Shift Registers Pin Layout" />
</a>
...
<a href="shift_registers_circuit_diagram.png">
    <img src="shift_registers_circuit_diagram.png" alt="Shift Registers Circuit Diagram" />
</a>
...
<a href="adc_pin_layout.png">
    <img src="adc_pin_layout.png" alt="ADC Pin Layout" />
</a>
...
<a href="adc_communication.png">
    <img src="adc_communication.png" alt="ADC Communication" class="thumb" />
</a>
...
<a href="adc_circuit_diagram.png">
    <img src="adc_circuit_diagram.png" alt="ADC Circuit Diagram" />
</a>
...
<ul class="gallery">
    <li>
        <a href="history/relays.png">
            <img src="history/relays.png" alt="Relays" title="Relays" />
            A picture showing the internal relays used to control actual power sockets, with v2 unpainted
        </a>
    </li>
    <li>
        <a href="history/binary-clock-v1-front.jpg">
            <img src="history/binary-clock-v1-front.jpg" alt="Front of binary clock v1" title="Front of binary clock v1" />
            The front of version one, built using a Netduino
        </a>
    </li>
    <li>
        <a href="history/binary-clock-v1-back.jpg">
            <img src="history/binary-clock-v1-back.jpg" alt="Back of binary clock v1" title="Back of binary clock v1" />
