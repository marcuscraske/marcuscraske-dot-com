...
title: Defcon 25
date: "2017-08-25"
thumbnail: "/blog/2017-08-25-defcon-25/me.jpg"
---
...
<ul class="gallery larger">
    <li>
        <a href="packet-hacking-village.jpg">
            <img src="packet-hacking-village.jpg" alt="Defcon 25 Packet Hacking Village" />
            Packet Hacking Village
        </a>
    </li>
    <li>
        <a href="esculators-main.jpg">
            <img src="esculators-main.jpg" alt="Defcon 25 main esculators" />
            Main Esculators
        </a>
    </li>
    <li>
        <a href="sms-otp.jpg">
            <img src="sms-otp.jpg" alt="Defcon 25 SMS OTP talk" />
...
<ul class="gallery larger">
    <li>
        <a href="esculators.jpg">
            <img src="esculators.jpg" alt="Defcon 25 esculators" />
            The Less Busy Esculators
        </a>
    </li>
    <li>
        <a href="hall.jpg">
            <img src="hall.jpg" alt="Defcon 25 hall" />
            Main Conference Hall
        </a>
    </li>
    <li>
        <a href="antennas.jpg">
            <img src="antennas.jpg" alt="Defcon 25 antenna man" />
            Cool Antenna Hack
        </a>
    </li>
</ul>
