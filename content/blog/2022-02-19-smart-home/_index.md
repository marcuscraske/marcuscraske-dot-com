...
title: Smart Home
date: "2022-02-19"
thumbnail: "/blog/2022-02-19-smart-home/microservices.png"
---
...
<p class="center">
  <a href="dashboard.jpg">
    <img src="dashboard.jpg" alt="Dashboard on TV" />
  </a>
</p>
...
<p class="center">
  <a href="microservices.png">
    <img src="microservices.png" alt="Microservice diagram" />
  </a>
</p>
...
<ul class="gallery">
    <li>
        <a href="bridges.jpg">
          <img src="bridges.jpg" alt="Philip Hue and Hive bridges, used for remote control" />
        </a>
    </li>
    <li>
        <a href="cabinet.jpg">
          <img src="cabinet.jpg" alt="Rack mounted in a 42U server cabinet, although the cabinet is not exclusively for this project" />
        </a>
    </li>
    <li>
        <a href="heating-receiver.jpg">
          <img src="heating-receiver.jpg" alt="Hive heating receiver" />
        </a>
    </li>
    <li>
        <a href="heating-thermostat.jpg">
          <img src="heating-thermostat.jpg" alt="Hive heating thermostat control" />
        </a>
    </li>
    <li>
        <a href="light-covered.jpg">
          <img src="light-covered.jpg" alt="Philip Hue mount over normal light switch, with magnetic removable remote" />
        </a>
    </li>
    <li>
        <a href="light-uncovered.jpg">
          <img src="light-uncovered.jpg" alt="Philip Hue mount cover removed" />
        </a>
    </li>
    <li>
        <a href="pi-rack.jpg">
          <img src="pi-rack.jpg" alt="Raspberry Pi 1U rack mount shelf" />
        </a>
    </li>
    <li>
        <a href="robovac-downstairs.jpg">
          <img src="robovac-downstairs.jpg" alt="Robovac (downstairs)" />
        </a>
    </li>
    <li>
        <a href="robovac-upstairs.jpg">
          <img src="robovac-upstairs.jpg" alt="Robovac (upstairs)" />
        </a>
    </li>
    <li>
        <a href="smart-plugs.jpg">
          <img src="smart-plugs.jpg" alt="Some of the smart plugs" />
        </a>
    </li>
</ul>
