...
date: "2023-04-01"
thumbnail: "/blog/2023-04-01-qcon-london-2023-paving-the-road/thumb.jpg"
---
...
## Paved Roads
<p class="center">
    <img src="paved-road.jpg" alt="Paved road, as an analogy" />
</p>
...
<ul class="gallery">
    <li>
        <a href="qcon-day2-keynote-radia-perlman.jpg">
          <img src="qcon-day2-keynote-radia-perlman.jpg" alt="Radia Perlman, creator of spanning tree algorithm, opening day two with a keynote" />
        </a>
    </li>
    <li>
        <a href="qcon-effective-efficient-observability.jpg">
          <img src="qcon-effective-efficient-observability.jpg" alt="Effective & Efficient Observability (SkyScanner)" />
        </a>
    </li>
    <li>
        <a href="qcon-effective-efficient-observability-2.jpg">
          <img src="qcon-effective-efficient-observability-2.jpg" alt="Effective & Efficient Observability (SkyScanner): Make golden path the path of least resistance" />
        </a>
    </li>
    <li>
        <a href="qcon-end-to-end-testing.jpg">
          <img src="qcon-end-to-end-testing.jpg" alt="Breaking Free From End-to-End Testing (Discover)" />
        </a>
    </li>
    <li>
        <a href="qcon-monzo-banking-thousands-microservices.jpg">
          <img src="qcon-monzo-banking-thousands-microservices.jpg" alt="Banking on Thousands of Microservices (Monzo)" />
        </a>
    </li>
    <li>
        <a href="qcon-platform-quote.jpg">
          <img src="qcon-platform-quote.jpg" alt="Quote on platform orchestration" />
        </a>
    </li>
    <li>
        <a href="qcon-snyk-predictions.jpg">
          <img src="qcon-snyk-predictions.jpg" alt="Predictions from Crystal Hirschorn (Snyk)" />
        </a>
    </li>
</ul>
