...
date: "2013-09-12"
thumbnail: "/blog/2013-09-12-hacking-nandos-pong-game/thumb.png"
---
...
## Legal Disclaimer
This post only presents what could be possible, and is not an admission of guilt, or/and actions,
nor does it condone such behaviour. And any photos are artistic in nature, and this article was written and exists
only for the purposes of entertainment and education.
...
<p class="center">
    <img src="game_submit.png" alt="Game Submit" />
</p>

<p class="center">
    <img src="wireshark_activity.png" alt="Wireshark Activity" />
</p>

If we look through the packets, we eventually find fragments of the data we just sent from the game:

<p class="center">
    <img src="packet_data.png" alt="Packet Data" />
</p>
...
<p class="center">
    <img src="wireshark_data.png" alt="Wireshark Data" />
</p>
...
<p class="center">
    <img src="wireshark_data_closer.png" alt="Wireshark Data Closer" />
</p>
...
<p class="center">
    <img src="highscore.png" alt="Highscore" />
</p>
