package com.limpygnome.legacy.jpa.providers;

import com.limpygnome.legacy.jpa.AbstractProvider;
import com.limpygnome.legacy.jpa.models.FinanceAccount;
import com.limpygnome.legacy.jpa.models.FinanceStatsMonthly;
import com.limpygnome.legacy.jpa.models.FinanceStatsOverview;
import com.limpygnome.legacy.jpa.models.FinanceTransaction;
...
public class FinanceProvider extends AbstractProvider
{
    public FinanceProvider(EntityManager em)
    {
        super(em);
    }
