<#global title="Hacking Nandos Pong Game">

${append_js("/content/syntaxhighlighter/scripts/shCore.js")}
${append_js("/content/syntaxhighlighter/scripts/shBrushCSharp.js")}
...
<h2>
    <a href="/articles">Articles</a> - Hacking Nandos Pong Game
</h2>

<h3>Introduction &amp; Reasons</h3>
<p>
...
<p>
    The purpose of this article is to show you the methodology I used to enter fake details into the system (as well as wipe them), discuss strategies to secure a system against this attack and with the hope that <b>future developers learn something and do not repeat the same mistakes</b>. Even though this article is published during the competition, I doubt many people will read it; you're also legally liable for your own actions. I also believe the legality of my actions have been ethical, please contact <a href="/contact">me</a> if you believe otherwise.
</p>
...
<h3>Step 1 - Reading  &amp; Understanding the Data Exchanged</h3>
<p>
    The first step was to begin recording exchanged packet data between the client (my browser running this game) and the server (nandos.co.uk); this was accomplished by using <a href="http://www.wireshark.org/">Wireshark</a>:
</p>
<p class="tac">
...
<p>
    <b>You'll also need to modify the content-length of the packet</b>; here is my complete program, demonstrating how to do that and all of the above:
</p>
